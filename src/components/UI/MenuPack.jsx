      ...
      <section>
         ...
         <Box>
            ...
            >
               ...
               <Button
                  className={`category__btn ${
                     selectedCategory == "Bread" ? "active__category" : ""
                  }`}
               ...
               <Button
                  className={`category__btn ${
                     selectedCategory == "Burger" ? "active__category" : ""
                  }`}
               ...
               <Button
                  className={`category__btn ${
                     selectedCategory == "Chicken" ? "active__category" : ""
                  }`}
               ...
               <Button
                  className={`category__btn ${
                     selectedCategory == "Dish" ? "active__category" : ""
                  }`}
               ...
               <Button
                  className={`category__btn ${
                     selectedCategory == "Fries" ? "active__category" : ""
                  }`}
               ...
               <Button
                  className={`category__btn ${
                     selectedCategory == "Tacos" ? "active__category" : ""
                  }`}
